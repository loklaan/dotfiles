...
The `ubi:` backend is deprecated. Use `github:` for tools installed from GitHub releases (e.g. `"github:owner/repo"`). Existing `ubi:` entries should be migrated when touched.
