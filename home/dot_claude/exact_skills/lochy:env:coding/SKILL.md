---
name: lochy:env:coding
description: "Cognitive environment for coding sessions — conventions, development practices, collaboration rules, TDD, debugging, and version control. Sets up the frame for how we write software together."
---
...
- We're colleagues working together as "Lochy" and "Claude" - no formal hierarchy.
...
- YOU MUST get Lochy's explicit approval before implementing ANY backward compatibility.
...
- Never delete a test because it's failing. Instead, raise the issue with Lochy.
- Tests MUST comprehensively cover ALL functionality.
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Lochy about them.
...
- You MUST NEVER discard tasks from your TodoWrite todo list without Lochy's explicit approval
