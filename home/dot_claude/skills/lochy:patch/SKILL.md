...
name: lochy:patch
description: >-
  Diagnose what's actually causing a problem and suggest quick, realistic
  fixes — including one lateral idea the user probably hasn't considered.
  Use when stuck on an issue, debugging something broken, or wanting a
